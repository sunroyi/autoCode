 ...
 */
package com.inesa.code.controller;
...
import com.inesa.code.service.CodeService;
...
public class CodeController {
    ...
    private void createController(String tableName, List<Code> codeList){
    	...
    	sb.append("package com.inesa." + className + ".controller;").append("\r\n");
    	sb.append("").append("\r\n");
    	...
    	sb.append("").append("\r\n");
    	sb.append("import com.github.pagehelper.PageHelper;").append("\r\n");
    	sb.append("import com.github.pagehelper.PageInfo;").append("\r\n");
    	sb.append("import com.inesa.common.entity.RestfulResult;").append("\r\n");
    	sb.append("import com.inesa.common.utils.CommUtils;").append("\r\n");
    	sb.append("import com.inesa.common.utils.Constants;").append("\r\n");
    	sb.append("import com.inesa.common.utils.StringUtils;").append("\r\n");
    	sb.append("import com.inesa." + className + ".entity." + HumpName + ";").append("\r\n");
    	sb.append("import com.inesa." + className + ".service." + HumpName + "Service;").append("\r\n");
    	sb.append("").append("\r\n");
    	sb.append("/**").append("\r\n");
		...
		sb.append("		").append("\r\n");
		sb.append("		try {").append("\r\n");
		sb.append("			PageHelper.startPage(" + humpName + ".getPageNo(), " + humpName + ".getPageSize());").append("\r\n");
		sb.append("").append("\r\n");
		sb.append("			List<" + HumpName + "> " + humpName + "List = " + humpName + "Service.findList(" + humpName + ");").append("\r\n");
		sb.append("").append("\r\n");
		sb.append("			PageInfo<" + HumpName + "> pageInfo = new PageInfo<" + HumpName + ">(" + humpName + "List);").append("\r\n");
		sb.append("	").append("\r\n");
		sb.append("			restfulResult.setData(" + humpName + "List);").append("\r\n");
		sb.append("			restfulResult.setCntData(pageInfo.getTotal());").append("\r\n");
		sb.append("	").append("\r\n");
		sb.append("		} catch (Exception ex) {").append("\r\n");
		sb.append("			restfulResult.setResult(Constants.RESULT_STATE_ERROR);").append("\r\n");
		sb.append("			restfulResult.setMessage(\"ERROR_99999\");").append("\r\n");
    ...
    private void createDao(String tableName, List<Code> codeList){
    	...
    	sb.append("package com.inesa." + className + ".dao;").append("\r\n");
    	sb.append("").append("\r\n");
    	sb.append("import java.util.List;").append("\r\n");
    	sb.append("").append("\r\n");
    	...
    	sb.append("").append("\r\n");
    	sb.append("import com.inesa." + className + ".entity." + HumpName + ";").append("\r\n");
    	sb.append("import com.inesa." + className + ".sql." + HumpName + "Sql;").append("\r\n");
    	sb.append("").append("\r\n");
    	sb.append("/**").append("\r\n");
    ...
    private void createService(String tableName, List<Code> codeList){
    	...
    	sb.append("package com.inesa." + className + ".service;").append("\r\n");
    	sb.append("").append("\r\n");
    	sb.append("import java.util.List;").append("\r\n");
    	sb.append("").append("\r\n");
    	sb.append("import org.springframework.beans.factory.annotation.Autowired;").append("\r\n");
    	...
    	sb.append("").append("\r\n");
    	sb.append("import com.inesa.common.service.CrudService;").append("\r\n");
    	sb.append("import com.inesa.common.utils.IdGen;").append("\r\n");
    	sb.append("import com.inesa.common.utils.StringUtils;").append("\r\n");
    	sb.append("import com.inesa." + className + ".dao." + HumpName + "Dao;").append("\r\n");
    	sb.append("import com.inesa." + className + ".entity." + HumpName + ";").append("\r\n");
    	sb.append("").append("\r\n");
    	sb.append("/**").append("\r\n");
    ...
    private void createEntity(String tableName, List<Code> codeList){
    	...
    	sb.append("package com.inesa." + className + ".entity;").append("\r\n");
    	sb.append("").append("\r\n");
    	sb.append("import java.util.Date;").append("\r\n");
    	sb.append("import com.inesa.common.entity.BaseEntity;").append("\r\n");
    	sb.append("").append("\r\n");
    	sb.append("/**").append("\r\n");
    ...
    private void createSql(String tableName, List<Code> codeList){
    	...
    	sb.append("package com.inesa." + className + ".sql;").append("\r\n");
    	sb.append("").append("\r\n");
    	...
    	sb.append("	").append("\r\n");
    	sb.append(" @Value(\"${jdbc.type}\")").append("\r\n");
    	sb.append("	private String dbName;").append("\r\n");
    	sb.append("	").append("\r\n");
